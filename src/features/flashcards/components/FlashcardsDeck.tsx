  ...
  if (!card) {
    return (
      <div className="border border-dashed border-border bg-card/40 plate rounded-sm p-10 text-center max-w-md mx-auto mt-12 space-y-3">
        ...
        <h3 className="font-bold text-foreground font-display text-sm">No cards to show</h3>
        <p className="text-sm text-muted-foreground leading-relaxed">Regenerate the deck to create a new set of cards.</p>
      </div>
    );
  }
